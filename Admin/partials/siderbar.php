            ...
            <div class="nano-content">
                <ul>
                    <div class="logo"><a href="index.html">
                            <!-- <img src="images/logo.png" alt="" /> --><span>Eshop</span></a></div>
                    ...
                    <li><a href="./products/addproducts.php"><i class="ti-calendar"></i> Add Products </a></li>
                    <li><a href="app-email.html"><i class="ti-email"></i>Delete Products</a></li>
                    <li><a href="app-profile.html"><i class="ti-user"></i>Update Products</a></li>
                    <li><a href="app-widget-card.html"><i class="ti-layout-grid2-alt"></i>See products</a></li>
                    ...
                    <li><a class="sidebar-sub-toggle"><i class="ti-panel"></i>Category<span
                                class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                            <li><a href="../categories/add_category.php">add category</a></li>
